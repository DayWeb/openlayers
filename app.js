...
function inicio(){
    ...
    var wmsdepartamentos=new ol.layer.Tile({
        ...
        source: new ol.source.TileWMS({
            ...
            url:'http://localhost:8080/geoserver/clase03/wms',
            params:{
	...
	function leyendawms(){
		...
		for(i=0;i<sincapas;i++){
			registros.push("http://localhost:8080/geoserver/clase03/wms?request=GetLegendGraphic&version=1.0.0&format=image/png&width=20&height=20&layer=clase03:Departamentos");
		}
		for(i=0;i<sincapas;i++){
